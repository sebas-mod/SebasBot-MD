...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  try {
    ...
    const str = `𝐋𝐈𝐍𝐊 𝐀𝐏𝐊 𝐏𝐎𝐏𝐏𝐘 𝐏𝐋𝐀𝐘𝐓𝐈𝐌𝐄

https://www.mediafire.com/file/bynkvjydgx1tzd2/Poppy%20Playtime%20v1.0.7%20@VictorRaulRR.apk/file
...
handler.command = /^(Apkpoppyplaytime|apkpoppyplaytime|poppyplaytimeapk)$/i;
handler.exp = 50;
handler.fail = null;
