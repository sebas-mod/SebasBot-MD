...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  try {
    ...
    const str = `𝐋𝐈𝐍𝐊 𝐀𝐏𝐊 𝐏𝐈𝐂𝐒𝐀𝐑𝐓 𝐏𝐑𝐄𝐌𝐈𝐔𝐌

https://www.mediafire.com/file/o50g5vnhqdn7jwm/PicsArt_v24.4_MOD_mundoperfecto.net.apk/file
...
handler.command = /^(Apkpicsart|apkpicsart|picsartapk)$/i;
handler.exp = 50;
handler.fail = null;
