...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  try {
    ...
    const str = `𝐀𝐏𝐊 𝐘𝐎𝐔𝐓𝐔𝐁𝐄 𝐌𝐔𝐒𝐈𝐂 𝐏𝐑𝐄𝐌𝐈𝐔𝐌

https://www.mediafire.com/file/fhht38qn5qz6yxp/YouTube%20Music%20Premium%20v6.13.52%20(Mod)%20@VictorRaulRR.apk/file
...
handler.command = /^(Apkyoutubemusic|apkyoutubemusic|youtubemusicapk)$/i;
handler.exp = 50;
handler.fail = null;
