...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  try {
    ...
    const str = `𝐋𝐈𝐍𝐊 𝐀𝐏𝐊 𝐂𝐀𝐏𝐂𝐔𝐓 𝐏𝐑𝐄𝐌𝐈𝐔𝐌

https://www.mediafire.com/file/orowjtxh5fqyw5j/CapCut%20Pro%20v10.5.0%20(Mod)%20@VictorRaulRR.apk/file
...
handler.command = /^(Apkcapcut|apkcapcut|capcutapk)$/i;
handler.exp = 50;
handler.fail = null;
